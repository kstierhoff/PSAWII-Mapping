...
pacman::p_load(xaringan,knitr,tidyverse,here,emo,sf,
...
---
## Map Server APIs
Add some more info to the map (obviously not "good" maps)
...
background-image: url(figs/geometries.png)
background-size: 300px
background-position: 50% 100%

## What are [simple features](https://r-spatial.github.io/sf/articles/sf1.html)?

- Until now we've been working with data frames with no explicit spatial attributes

- Most location data are from a GPS and have latitude/longitude coordinates in of the WGS84 datum
...
- Geometry types: (MULTI)POINT, (MULTI)LINESTRING, (MULTI)POLYGON, GEOMETRYCOLLECTION
...
The geometry is abbreviated, but you can view it completely by printing
...
Buffer (st_buffer), Spatial subsetting (st_intersection, st_difference), Casting (st_cast), Area calculations (st_area)
