...
```{r,fig.align='center'}
include_graphics(here("Images/git-zip.png"))
```

## Guiding Principles
There are many ways to accomplish mapping and spatial analysis tasks using R (e.g., `sp` package, the [R-ArcGIS Bridge](https://r-arcgis.github.io/)).  
...
```{r,fig.align='center'}
include_graphics(here("Images/earth.jpg"))
```
